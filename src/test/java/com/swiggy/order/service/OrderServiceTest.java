...
public class OrderServiceTest {
    ...
    void getAllOrdersSuccessfully() {
        ...
        List<Order> orders = List.of(
                Order.builder().id(1L).restaurantId(1L).customerId(1L).deliveryAddress("123 Main St").orderLines(firstOrderLines).totalPrice(10.0).build(),
                Order.builder().id(2L).restaurantId(2L).customerId(2L).deliveryAddress("456 Elm St").orderLines(secondOrderLines).totalPrice(20.0).build()
        );
